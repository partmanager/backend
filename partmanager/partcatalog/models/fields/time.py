...
class Time(CompositeField):
    min = models.DecimalField(max_digits=13, decimal_places=13, null=True, blank=True)
    typ = models.DecimalField(max_digits=13, decimal_places=13, null=True, blank=True)
    max = models.DecimalField(max_digits=13, decimal_places=13, null=True, blank=True)
