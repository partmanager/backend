...
class BridgeRectifierJsonImportTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        Part.objects.all().delete()

        manufacturer = Manufacturer(name="TestBridgeRectifierManufacturer", full_name="TestBridgeRectifierManufacturer")
        manufacturer.save()

        # Set up non-modified objects used by all test methods
        json_importer.parts_import('partcatalog/importers/test_data/json/test_bridge_rectifiers.json')
    ...
    def test_imported_part(self):
        ...
        self.assertEqual(part.manufacturer_part_number, "TESTBRIDGERECTIFIER#")
        self.assertEqual(part.manufacturer.name, "TestBridgeRectifierManufacturer")
