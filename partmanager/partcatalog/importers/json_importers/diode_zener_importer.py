from partcatalog.models.diode import ZenerDiode
...
class DiodeZenerJsonImporter(ModelImporter):
    def __init__(self):
        super().__init__(ZenerDiode,
                         part_type=['Zener Diode'],
